(function(){
  ...
  Game.prototype.drawIntro = function(ctx, img){
  ...
  Game.prototype.drawLost = function(ctx, img){
    ...
    ctx.font = '24px Helvetica Neue';
    ctx.fillText('Score: ' + this.finalScore(), (this.xDim / 2) - 100, (this.yDim / 2) + 20);
    ctx.fillText('Press enter to play again', (this.xDim / 2) - 100, (this.yDim / 2) + 50 );
  };
  ...
  Game.prototype.draw = function (ctx, img) {
    ...
    ctx.fillStyle = 'white';
    ctx.fillText("Score: " + this.points, 40, this.yDim - 190);
  ...
  Game.prototype.finalScore = function () {
    return (this.points + ((this.lives + 1) * 1000))
  }
})();
